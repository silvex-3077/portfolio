...
export async function getAllPosts(): Promise<CollectionEntry<'note'>[]> {
...
export function groupPostsByYear(
  posts: CollectionEntry<'note'>[],
): Record<string, CollectionEntry<'note'>[]> {
  return posts.reduce(
    (acc: Record<string, CollectionEntry<'note'>[]>, post) => {
